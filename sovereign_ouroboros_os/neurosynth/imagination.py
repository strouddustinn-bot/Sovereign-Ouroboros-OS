...
handful of distinct candidate :class:`~sovereign_ouroboros_os.core.types.Prototype`
...
in :mod:`sovereign_ouroboros_os.core.embedding`.
"""
...
from sovereign_ouroboros_os.core.types import Prototype, Vector
...
class NeuroSynth:
    ...
    Satisfies the :class:`~sovereign_ouroboros_os.core.contracts.Imaginer`

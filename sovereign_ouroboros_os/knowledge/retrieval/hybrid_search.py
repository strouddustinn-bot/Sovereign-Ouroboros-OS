...
Pipeline for a single :class:`~sovereign_ouroboros_os.knowledge.schemas.KBQuery`:
...
class HybridSearch:
    ...
    ----------
    store:
        The :class:`~sovereign_ouroboros_os.knowledge.storage.sqlite_store.SQLiteKBStore`

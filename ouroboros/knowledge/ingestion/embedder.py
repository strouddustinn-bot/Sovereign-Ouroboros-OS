...
Wraps the core :func:`~ouroboros.core.embedding.embed` function
and drives it over a list of :class:`~ouroboros.knowledge.schemas.Chunk`
objects, persisting each vector into the store via
:meth:`~ouroboros.knowledge.storage.sqlite_store.SQLiteKBStore.upsert_vector`.
"""
...
class Embedder:
    ...
    Hash) as selected by :func:`~ouroboros.core.embedding.embed`.
